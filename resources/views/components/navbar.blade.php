<nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 top-0">
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center justify-start">
          ...
          <a href="{{ "/" }}" class="flex ml-2 md:mr-24">
            ...
            <span class="self-center text-base font-semibold sm:text-lg whitespace-nowrap dark:text-white">Dashboard</span>
          </a>
