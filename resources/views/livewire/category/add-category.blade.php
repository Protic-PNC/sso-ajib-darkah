                ...
                <div class="grid gap-4 mt-4">
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="dropzone-file" class="relative flex flex-col items-center justify-center w-full h-auto border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                                ...
                                <div wire:loading wire:target="image" class="absolute w-full h-full bg-[#00000014]">
                                    <div class="w-full h-full flex items-center justify-center">
                                        <img class="w-20" src="{{ asset('images/upload.gif') }}" alt="">
                                    </div>
                                </div>
                            </label>
                        </div>
